...
if count eq 0 then begin
   print,'quicklook directory is already cleaned'
   return
endif
...
for i=0L,count-1 do begin
   ...
   if outdir ne '' then begin
     ...
     print,'moving '+files[i]+' to '+opath+ofile
     file_move,files[i],opath+ofile
  endif
...
return
;
; CSV files are no longer needed for cleanup
;
